...
class CustomTrainer(Trainer):
    ...
    def epoch_train(self, dataloader, model, loss_fn, optimizer, device, epoch,use_checkpoint=False,best_model=False):
        ...
        _, precision, recall, f1_score, sensitivity, specificity, auc_score = calculate_metrics_multilabel(
            out_gt, out_pred)
    ...
    def epoch_evaluate(self, dataloader, model, loss_fn, device, epoch=0, use_checkpoint= False,best_model=False):
        ...
        accuracy, precision, recall, f1_score, sensitivity, specificity, auc_score = calculate_metrics_multilabel(
            out_gt, out_pred)
