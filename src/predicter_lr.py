...
import json
from src.trainer_lr import CustomTrainer
...
class Predicter():
    ...
    def predict(self):
        ...
        # Result
        labels = ['left', 'right']
        result = {'prob_left': 0, 'prob_right': 0, 'label': labels[0]}
        ...
        with torch.no_grad():
            ...
            result['label'] = labels[0] if result['prob_left'] > result['prob_right'] else labels[1]
